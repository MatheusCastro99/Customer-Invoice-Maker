...
//GENERATE INVOICE: IMPLEMENT INVOICE COUNT (COUNT IN RESPECT TO KENTECH/NOT INDIVIDUAL || OPEN MANUAL COUNT)!!!
//EVERYWHERE: IMPLEMENT EMAIL ON CUSTOMER MODEL (AND OTHER PAGES)
...
//(CHANGE PROPS FROM CUSTOMER DB COLLECTION TO INVOICE DB COLLECTION ON INVOICE TABLE PDF CLICK, PASS COMPLETE CUSTOMER INFO ON INVOICE MODEL)
